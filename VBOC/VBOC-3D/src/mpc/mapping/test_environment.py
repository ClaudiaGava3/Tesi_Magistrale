...
from lidar import get_lidar_hits_3d_qualsiasi, min_cube_warm_start_3d
...
# ==========================================
    ...
    if len(frames_animazione) > 0:
        ...
        nome_video = os.path.join(cartella_video, f"Video_Target_{test_idx+10:02d}_{esito}.mp4")
