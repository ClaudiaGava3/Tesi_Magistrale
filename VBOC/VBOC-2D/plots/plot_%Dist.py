...
def create_success_plot():
    ...
    # y1 = np.array([4/13*100,4/13*100,3/13*100])  #N10
    # y2 = np.array([5/13*100,4/13*100,3/13*100])   #N15
    # y3 = np.array([11/13*100,5/13*100,6/13*100])  #N20
    # y4 = np.array([10/13*100,3/13*100,6/13*100])   #N25
    # y5 = np.array([7/13*100,3/13*100,6/13*100])  #N30
